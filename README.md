...
| **[SENTINEL](https://github.com/rb2625/sentinel)** | Urban incident detection using Nokia CAMARA network APIs orchestrated by a multi-agent AI system. Built for GSMA MENA Ignite Hackathon. (private for now) | FastAPI, Next.js, CrewAI, Nokia NaC |
